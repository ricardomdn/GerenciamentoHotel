...
public class HotelApp {
    ...
    public static void main(String[] args) {
        while (true) {
            String menu = "1. Cadastrar Hóspede\n"
                    + "2. Cadastrar Quarto\n"
    ...
    private static void atualizarHospede() {
        ...
        if (hospede != null) {
            ...
            String dataNascimento = JOptionPane.showInputDialog("Nova data de nascimento (dd/MM/yyyy):", hospede.getDataNascimento());
    ...
    private static void atualizarFuncionario() {
        ...
        if (funcionario != null) {
            ...
            double salario = Double.parseDouble(JOptionPane.showInputDialog("Novo salário:", funcionario.getSalario()));
            String turno = JOptionPane.showInputDialog("Novo turno de trabalho:", funcionario.getTurno());

            Funcionario novoFuncionario = new Funcionario(nome, cpf, cargo, salario, turno);
    ...
    private static void checkIn() {
        ...
        if (hospede != null) {
            ...
            if (quarto != null && quarto.getStatus().equals("disponível")) {
                String dataEntrada = JOptionPane.showInputDialog("Data de entrada (dd/MM/yyyy):");
                String dataSaida = JOptionPane.showInputDialog("Data de saída (dd/MM/yyyy):");

                if (validarData(dataEntrada, dataSaida)) {
                    try {
                        Date dataEntradaDate = dateFormat.parse(dataEntrada);
                        quarto.setDataEntrada(dataEntradaDate); // Armazenar a data de entrada2
